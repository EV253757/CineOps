...
function App() {
  ...
  async function deleteUser(email) {
    if (!window.confirm(`¿Eliminar el acceso de ${email}? Tendrá que solicitar acceso nuevamente.`)) return;
